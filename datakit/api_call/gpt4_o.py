...
def query_gpt4o(prompt: str,
                ...
                system_prompt=None,
                temperature=0.7,
                mini=True) -> Optional[str]:
    """Query GPT-4o API to generate a response to a prompt with images.
    ...
    Args:
        ...
        mini (bool, optional): Whether to use the mini model or the full model.
            Defaults to True.
    ...
    req = {
        'model': 'gpt-4o-mini' if mini else 'gpt-4o',
        'messages': messages,
