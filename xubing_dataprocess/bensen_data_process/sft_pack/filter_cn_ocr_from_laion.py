...
if __name__ == '__main__':
    ...
    root = '/mnt/cephfs/bensenliu/wfs/vlmdatasets/pt/laion5b-cn-512/data/0'
    output_file = f'/mnt/cephfs/bensenliu/wfs/vlmdatasets/sft-pointsv1.2/laion5b-cn-ocr/data/grammar_correct/laion5b-cn-ocr_{rank}.jsonl'
