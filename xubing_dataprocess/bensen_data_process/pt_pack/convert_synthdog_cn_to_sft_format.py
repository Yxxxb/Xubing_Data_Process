...
if __name__ == '__main__':
    ...
    input_root = '/mnt/cephfs/bensenliu/wfs/vlmdatasets/pt/synthdog-zh/data'
    output_file = f'/mnt/cephfs/bensenliu/wfs/vlmdatasets/pt/synthdog-zh/data/sft-format/{rank}.jsonl'
