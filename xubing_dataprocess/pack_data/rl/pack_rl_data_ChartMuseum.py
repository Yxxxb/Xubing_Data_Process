...
# pip install pyarrow
parquets_path = "/mnt/cephfs/xubingye/wfs/datasets/rl-category/ChartMuseum/data"
use_val = False
...
for i, df in enumerate(parquet_files):
    ...
    for index, row in tqdm(df.iterrows()):
        img_path = "/mnt/cephfs/xubingye/wfs/datasets/rl-category/ChartMuseum/" + row['image']
